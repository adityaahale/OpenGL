...
XMMATRIX OrthographicProjectionMatrixAta;
...
HRESULT initialize(void)
{
	...
	OrthographicProjectionMatrixAta = XMMatrixIdentity();
...
HRESULT resize(int width, int height)
{
	...
	if (width <= height)
	{
		OrthographicProjectionMatrixAta = XMMatrixOrthographicOffCenterLH(
...
void display()
{
	...
	XMMATRIX wvpMatrixAta = worldMatrixAta * viewMatrixAta * OrthographicProjectionMatrixAta;
