...
function init(){
	...
	isPerVertexLightingUniformAta = gl.getUniformLocation(shaderProgramObject_ata, "u_is_per_vertex"); 
	isPerFragmentLightingUniformAta = gl.getUniformLocation(shaderProgramObject_ata, "u_is_per_fragment"); 
...
function draw()
{
	...
	if(gbLightAta == true)
	{
		if (isPerVertexAta) 
		{
			gl.uniform1i(isPerVertexLightingUniformAta, 1);
			gl.uniform1i(isPerFragmentLightingUniformAta, 0);
		}
		else
		{
			gl.uniform1i(isPerFragmentLightingUniformAta, 1);
			gl.uniform1i(isPerVertexLightingUniformAta, 0);
		}
