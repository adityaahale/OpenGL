...
var orthographicProjectionMatrixAta;
...
function init(){
	...
	var triangleVerticesAta  = new Float32Array([0.0, 50.0, 0.0,
											-50.0,-50.0,0.0,
											50.0, -50.0, 0.0
											]);
	...
	orthographicProjectionMatrixAta =  mat4.create();
}
...
function resize()
{
	...
	{
		mat4.ortho(orthographicProjectionMatrixAta, -100.0, 100.0, (-100.0 * (canvas.height/canvas.width)),
		(100.0 * (canvas.height/canvas.width)),-100.0, 100.0);		
	}else
	{
		mat4.ortho(orthographicProjectionMatrixAta, -100.0, 100.0, (-100.0 * (canvas.width/canvas.height)),
...
function draw()
{
	...
	var angleInRadianAta = degreeToRadian(gAngle);
	//mat4.translate(modelViewMatrixAta,modelViewMatrixAta,[0.0,0.0,-3.0]);
	//mat4.rotateY(modelViewMatrixAta, modelViewMatrixAta,angleInRadianAta);
	mat4.multiply(modelViewProjectionMatrixAta, orthographicProjectionMatrixAta, modelViewMatrixAta);
