...
function draw()
{
	...
	var cubeTexcoordsAta = new Float32Array(8);
	
	if (keyPressAta == 1) 
	{ 
		cubeTexcoordsAta[0] = 0.0;
		cubeTexcoordsAta[1] = 1.0;
		cubeTexcoordsAta[2] = 0.0;
		cubeTexcoordsAta[3] = 0.0;
		cubeTexcoordsAta[4] = 1.0;
		cubeTexcoordsAta[5] = 0.0;
		cubeTexcoordsAta[6] = 1.0;
		cubeTexcoordsAta[7] = 1.0;
	}
	else if (keyPressAta == 2) 
	{ 
		cubeTexcoordsAta[0] = 0.0;
		cubeTexcoordsAta[1] = 0.5;
		cubeTexcoordsAta[2] = 0.0;
		cubeTexcoordsAta[3] = 0.0;
		cubeTexcoordsAta[4] = 0.5;
		cubeTexcoordsAta[5] = 0.0;
		cubeTexcoordsAta[6] = 0.5;
		cubeTexcoordsAta[7] = 0.5;
	}
	else if (keyPressAta == 3) 
	{
		cubeTexcoordsAta[0] = 0.0;
		cubeTexcoordsAta[1] = 2.0;
		cubeTexcoordsAta[2] = 0.0;
		cubeTexcoordsAta[3] = 0.0;
		cubeTexcoordsAta[4] = 2.0;
		cubeTexcoordsAta[5] = 0.0;
		cubeTexcoordsAta[6] = 2.0;
		cubeTexcoordsAta[7] = 2.0;
	} 
	else if (keyPressAta == 4) 
	{ 
		cubeTexcoordsAta[0] = 0.5;
		cubeTexcoordsAta[1] = 0.5;
		cubeTexcoordsAta[2] = 0.5;
		cubeTexcoordsAta[3] = 0.5;
		cubeTexcoordsAta[4] = 0.5;
		cubeTexcoordsAta[5] = 0.5;
		cubeTexcoordsAta[6] = 0.5;
		cubeTexcoordsAta[7] = 0.5;
	}
	...
	gl.bindVertexArray(vao_cube_ata);
	gl.bindBuffer(gl.ARRAY_BUFFER, vbo_texture);
	gl.bufferData(gl.ARRAY_BUFFER, cubeTexcoordsAta, gl.DYNAMIC_DRAW);
