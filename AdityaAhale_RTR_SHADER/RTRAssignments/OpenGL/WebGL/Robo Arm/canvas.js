...
function draw() {
    ...
    var angleInRadianS = degreeToRadian(shoulder);
    var angleInRadianE = degreeToRadian(elbow);

    gl.vertexAttrib3f(WebGLMacros.ATA_ATTRIBUTE_COLOR, 0.5, 0.35, 0.05);

    mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [-0.5, 0.0, -10.0]);
    mat4.rotateZ(modelViewMatrix_ata, modelViewMatrix_ata, angleInRadianS);
    mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [1.0, 0.0, 0.0]);
    mat4.scale(modelViewMatrix_ata, modelViewMatrix_ata, [2.0, 0.5, 1.0]);
    ...
    mat4.scale(modelViewMatrix_ata, modelViewMatrix_ata, [0.5, 2.0, 1.0]);
    mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [2.0, 0.0, 0.0]);
    mat4.rotateZ(modelViewMatrix_ata, modelViewMatrix_ata, angleInRadianE);
    mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [1.0, 0.0, 0.0]);
    mat4.scale(modelViewMatrix_ata, modelViewMatrix_ata, [2.0, 0.5, 1.0]);
