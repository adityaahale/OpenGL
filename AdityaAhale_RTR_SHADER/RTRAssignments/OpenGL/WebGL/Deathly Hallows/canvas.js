...
var xtrans = -3.0, ytrans = -3.0, xctrans = 3.0, yctrans = -3.0, yltrans = 3.0;
...
function draw()
{
	...
	mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [tx + xctrans, ty - yctrans, -3.0]);
	...
	mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [xtrans, ytrans, -3.0]);
	mat4.rotateY(modelViewMatrix_ata, modelViewMatrix_ata, angleInRadian);
	mat4.multiply(modelViewProjectionMatrix_ata, perspectiveProjectionMatrix_ata, modelViewMatrix_ata);
	...
	mat4.translate(modelViewMatrix_ata, modelViewMatrix_ata, [0.0, yltrans, -3.0]);
...
function update()
{
        ...
        if (xtrans >= 0.0) {
            if (xctrans > 0.0) {
                xctrans = xctrans - 0.01;
                yctrans = yctrans + 0.01;
