...
mat4 modelViewMatrix;
	...
	//rotationMatrix = rotate(angleCu, 1.0f, 0.0f, 0.0f);
	...
	if (oneside == true)
	{
		translationMatrix = translate(sinf(AngleCube), 0.0f, -6.0f + cosf(AngleCube));
	...
	//translationMatrix = translate(sinf((GLfloat)year), 0.0f, -6.0f+cosf((GLfloat)year));
