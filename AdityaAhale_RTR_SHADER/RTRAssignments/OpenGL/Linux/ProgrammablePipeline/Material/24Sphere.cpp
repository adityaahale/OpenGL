		...
		for (int j = 0; j < 4; j++)
		{
			...
			if (gbLighting == true)
			{
				...
				if (lighRotX) 
				{
					...
					lightPosition[1] = myRadius * cosf(AnglePyramid);
					lightPosition[2] = myRadius * sinf(AnglePyramid);
				}
				else if (lighRotY)
				{
					lightPosition[0] = myRadius * cosf(AnglePyramid);
				...
				{
					lightPosition[0] = myRadius * cosf(AnglePyramid);
					lightPosition[1] = myRadius * sinf(AnglePyramid);
