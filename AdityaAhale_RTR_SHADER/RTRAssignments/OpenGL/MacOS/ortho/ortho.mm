...
-(void)reshape
{
    ...
    if (widthAta <= heightAta)
        orthographicProjectionMatrix_ata = vmath::ortho(
                                                    -100.0f, 100.0f, (-100.0f*(heightAta / widthAta)), (100.0f * (heightAta / widthAta)),
                                                    -100.0f, 100.0f);
    else
        orthographicProjectionMatrix_ata = vmath::ortho(
                                                    -100.f, 100.0f, (-100.0f*(widthAta / heightAta)), (100.0f * (widthAta/heightAta)),
                                                    -100.0f, 100.0f);
    CGLUnlockContext((CGLContextObj)[[self openGLContext]CGLContextObj]);
