...
{
    //Code for log file
    NSBundle *mainBundle_ata = [NSBundle mainBundle];
    NSString *appDirNameAta = [mainBundle_ata bundlePath];
...
-(void)prepareOpenGL
{
    ...
    glBindAttribLocation(shaderProgramObject_ata, ATA_ATTRIBUTE_VERTEX, "vPosition");
    ...
    glVertexAttribPointer(ATA_ATTRIBUTE_VERTEX, 3, GL_FLOAT, GL_FALSE, 0, NULL);
    glEnableVertexAttribArray(ATA_ATTRIBUTE_VERTEX);
...
-(void)drawView
{
    ...
    modelViewMatrixAta = vmath::translate(0.0f, 0.0f, -3.0f);
