...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, AppName, TEXT("OGL_Shape"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 0, 0, 800, 600, NULL, NULL, hInstance, NULL);
...
void display(void)
{
	...
	TranslateMatrix[14] = -6.0f;//tz
	TranslateMatrix[15] = 1.0f;

	YRotMatrix[0] = (GLfloat)cos(rot);//cos
	YRotMatrix[1] = 0.0f;
	YRotMatrix[2] = (GLfloat)-sin(rot);//-sin
	YRotMatrix[3] = 0.0f;
	YRotMatrix[4] = 0.0f;
	YRotMatrix[5] = 1.0f;
	YRotMatrix[6] = 0.0f;
	YRotMatrix[7] = 0.0f;
	YRotMatrix[8] = (GLfloat)sin(rot);//sin
	YRotMatrix[9] = 0.0f;
	YRotMatrix[10] = (GLfloat)cos(rot);//cos
	YRotMatrix[11] = 0.0f;
	YRotMatrix[12] = 0.0f;
	YRotMatrix[13] = 0.0f;
	YRotMatrix[14] = 0.0f;
