...
GLfloat angleTri = 0.0f, angleSq = 0.0f,angleDH=0.0f;
...
void display(void)
{
	...
	rotatationMatrix = rotate(angleDH, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * translationMatrix * rotatationMatrix;
