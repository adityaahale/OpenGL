...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	public void draw(){
		...
		switch(tapCount){
		case 1:
			GLES32.glViewport(0, 0, winWidth/2, winHeight/2);
			break;
		case 2:
			GLES32.glViewport(winWidth/2, 0, winWidth / 2, winHeight / 2);
			break;
		case 3:
			GLES32.glViewport(winWidth/2, winHeight/2, winWidth/2, winHeight / 2);
			break;
		case 4:
			GLES32.glViewport(0, winHeight/2, winWidth / 2, winHeight / 2);
			break;
		case 5:
			GLES32.glViewport(0, 0, winWidth / 2, winHeight);
			break;
		case 6:
			GLES32.glViewport(winWidth/2, 0, winWidth/2 , winHeight);
			break;
		case 7:
			GLES32.glViewport(0, winHeight/2, winWidth, winHeight / 2);
			break;
		case 8:
			GLES32.glViewport(0, 0, winWidth, winHeight / 2);
			break;
		case 9:
