...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	public void draw(){
		...
		Matrix.translateM(translate2Matrix, 0, 1.0f, 0.0f, 0.0f);
		Matrix.rotateM(rotationMatrixSho, 0, (float)shoulder , 0.0f, 0.0f, 1.0f);
		...
		Matrix.translateM(translate3Matrix, 0, 1.0f, 0.0f, 0.0f);
		Matrix.rotateM(rotationMatrixElb, 0, (float)elbow , 0.0f, 0.0f, 1.0f);
