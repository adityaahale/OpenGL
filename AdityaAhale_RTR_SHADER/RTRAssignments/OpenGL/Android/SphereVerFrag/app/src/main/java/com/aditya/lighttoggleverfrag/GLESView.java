package com.aditya.lighttoggleverfrag;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private boolean isPerFragment=true;
	private boolean isPerVertex = true;
	...
	private void initialize(GL10 gl){
		...
		doubleTapUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_lighting_enabled");
		...
		isPerVertexLightingUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_is_per_vertex_lighting"); 
		isPerFragmentLightingUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_is_per_fragment_lighting"); 
		isPerFragmentLightingUniform = GLES32.glGetUniformLocation(shaderProgramObject, "u_is_per_fragment_lighting"); 
	...
	public void draw(){
		...
		if(isLightning == true)
		{
			...
			if (isPerVertex) {
				GLES32.glUniform1i(isPerVertexLightingUniform, 1);
				GLES32.glUniform1i(isPerFragmentLightingUniform, 0);
			}
			else if(isPerFragment)
			{
				GLES32.glUniform1i(isPerFragmentLightingUniform, 1);
				GLES32.glUniform1i(isPerVertexLightingUniform, 0);
			}
