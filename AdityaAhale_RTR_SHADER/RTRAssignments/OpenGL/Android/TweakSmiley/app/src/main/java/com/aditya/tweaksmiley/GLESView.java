package com.aditya.tweaksmiley;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl){
		...
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, 32, null, GLES32.GL_DYNAMIC_DRAW);
	...
	public void draw(){
		float smileyTexcoords[]=new float[8];
		if (tapCount == 1) { 
		smileyTexcoords[0] = 0.0f;
		smileyTexcoords[1] = 1.f;
		smileyTexcoords[2] = 0.0f;
		smileyTexcoords[3] = 0.0f;
		smileyTexcoords[4] = 1.0f;
		smileyTexcoords[5] = 0.0f;
		smileyTexcoords[6] = 1.0f;
		smileyTexcoords[7] = 1.0f;
		
		
	}else if (tapCount == 2) { 
		smileyTexcoords[0] = 0.0f;
		smileyTexcoords[1] = 0.5f;
		smileyTexcoords[2] = 0.0f;
		smileyTexcoords[3] = 0.0f;
		smileyTexcoords[4] = 0.5f;
		smileyTexcoords[5] = 0.0f;
		smileyTexcoords[6] = 0.5f;
		smileyTexcoords[7] = 0.5f;
	}
	else if (tapCount == 3) { 
		smileyTexcoords[0] = 0.0f;
		smileyTexcoords[1] = 2.0f;
		smileyTexcoords[2] = 0.0f;
		smileyTexcoords[3] = 0.0f;
		smileyTexcoords[4] = 2.0f;
		smileyTexcoords[5] = 0.0f;
		smileyTexcoords[6] = 2.0f;
		smileyTexcoords[7] = 2.0f;
	} 
	else if (tapCount == 4) { 
		smileyTexcoords[0] = 0.5f;
		smileyTexcoords[1] = 0.5f;
		smileyTexcoords[2] = 0.5f;
		smileyTexcoords[3] = 0.5f;
		smileyTexcoords[4] = 0.5f;
		smileyTexcoords[5] = 0.5f;
		smileyTexcoords[6] = 0.5f;
		smileyTexcoords[7] = 0.5f;
	}
		
		ByteBuffer byteBuffer =  ByteBuffer.allocateDirect(smileyTexcoords.length * 4); //4 is size of float.
		byteBuffer.order(ByteOrder.nativeOrder()); //Detect native machine endianess and use it
		FloatBuffer verticesBuffer = byteBuffer.asFloatBuffer();
