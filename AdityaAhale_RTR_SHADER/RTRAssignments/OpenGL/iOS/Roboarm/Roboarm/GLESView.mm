...
-(void)drawView:(id)sender
{
    ...
    vmath::mat4 translation3MatrixAta = mat4::identity();
    vmath::mat4 translation4MatrixAta = mat4::identity();
    vmath::mat4 rotationMatrixShoAta = mat4::identity();
    vmath::mat4 rotationMatrixElbAta = mat4::identity();
    
   
    //bind square vao
    
    translationMatrixAta = vmath::translate(0.0f, 0.0f, -10.0f);
    translation2MatrixAta = vmath::translate(1.0f, 0.0f, 0.0f);
    rotationMatrixShoAta = vmath::rotate((GLfloat)shoulder,0.0f, 0.0f, 1.0f);
	
	modelViewMatrixAta = modelViewMatrixAta * translationMatrixAta;
	modelViewMatrixAta = modelViewMatrixAta * rotationMatrixShoAta;
	modelViewMatrixAta = modelViewMatrixAta * translation2MatrixAta * vmath::scale(2.0f,0.5f,1.0f);
	...
	glVertexAttrib3f(ATA_ATTRIBUTE_COLOR, 0.5f, 0.35f, 0.05f);
	...
	translation3MatrixAta = vmath::translate(1.0f, 0.0f, 0.0f);
	rotationMatrixElbAta = vmath::rotate((GLfloat)elbow,0.0f, 0.0f, 1.0f);
	translation4MatrixAta = vmath::translate(1.0f, 0.0f, 0.0f);
    
	
	modelViewMatrixAta = modelViewMatrixAta * vmath::scale(0.5f,2.0f,1.0f);
	modelViewMatrixAta = modelViewMatrixAta * translation3MatrixAta;
	modelViewMatrixAta = modelViewMatrixAta * rotationMatrixElbAta;
	modelViewMatrixAta = modelViewMatrixAta * translation4MatrixAta * vmath::scale(2.0f,0.5f,1.0f);
